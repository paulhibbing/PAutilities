...
This vignette will show you how to implement the CRIB method. The
...
* **method = "CRIB"** Here we specify that R should run the
  CRIB method. Right now, this is the only
...
This should give you a broad sense of how to use the CRIB method and what else you can do with it. Feel free to [post an issue on the GitHub page](https://github.com/paulhibbing/PAutilities/issues/new/choose) if any of the above gives you trouble. Good luck!
